    ...
    <form class="form-inline mt-12 mt-md-0 p-3">
      <ul class="navbar-nav">
        <li class="nav-item" id="panier">
          <a class="nav-link text-muted" href="<?php echo site_url('investisseur/payement'); ?>">
        ...
        <li class="nav-item" id="panier">
          ...
          function getStatus($url, $toSee)
          {
            echo ("<a class='nav-link text-muted' href=" . $url . ">
                    <small>
                      " . $toSee . "
                    </small>
                  </a>");
          ...
          if (!isset($_SESSION['isLogin'])) {
            getStatus(site_url('loginController/index'), 'Se Connecter');
          } else {
            getStatus(site_url('investisseur/index'), 'Mon Compte');
          }
          ?>
        </li>
      </ul>
