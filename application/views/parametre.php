	...
	<body>
		...
		<header>
			...
			<div class="container-fluid text-center" id="Notifications">
				<div class="row">
					<div class="col">
						<img src="img/pro1.jpg" class="rounded-circle" width="70">
						<h1>
			...
			<div class="w-100">
				<div class="container">
					<div class="container r-p bg-light  p-3 text-center">
					...
					<br>
					<div class="container r-p bg-danger text-white  p-3 text-center">
