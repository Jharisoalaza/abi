				...
				<div class="container" style="margin-top: 2%">
					...
					<div class="row">
						<div class="col-lg-5 p-4">
							<form action="">
								<div class="container">
									<select name="m_payer" id="m_payer" class="btn btn-light-sm mb-4" style="text-align: left;">
										<option value="m_monney" class="item">Mobile Monney</option>
										<option value="btc">BitCoins</option>
									</select>
									<input type="text" name="represantant" placeholder="Code de votre representant..." class="btn btn-light" style="cursor: text;text-align: left;">
									<br><br>
									<input type="text" name="parrain" placeholder="Code de votre parrain." class="btn btn-light" style="cursor: text;text-align: left;">
									<br><br>
